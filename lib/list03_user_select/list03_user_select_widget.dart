...
class List03UserSelectWidget extends StatefulWidget {
  const List03UserSelectWidget({Key? key}) : super(key: key);

  @override
  _List03UserSelectWidgetState createState() => _List03UserSelectWidgetState();
}
            ...
            children: [
              Text(
                FFLocalizations.of(context).getText(
                  'xuxgii61' /* Invite Friends */,
                ),
                style: FlutterFlowTheme.of(context).headlineSmall,
              ),
              Text(
                FFLocalizations.of(context).getText(
                  'b15k6yaa' /* Invite your friends to join yo... */,
                ),
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final items = FFAppState().itmes.toList();
                  ...
                  children: [
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.pushNamed('InsertItem');
                        },
                        text: FFLocalizations.of(context).getText(
                          'e4fgq877' /* See Selected */,
                        ),
